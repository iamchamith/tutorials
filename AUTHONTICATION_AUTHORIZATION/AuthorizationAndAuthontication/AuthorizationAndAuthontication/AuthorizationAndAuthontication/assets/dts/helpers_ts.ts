...
module TownSuite.Modules {
    // set in BaseLoggedInMaster.master
    export function EnableCustomerPortal() {
        return BaseLoggedInMaster.enableCustomerPortal;
    }

    // set in BaseLoggedInMaster.master
    export function EnableRecreationPortal() {
        return BaseLoggedInMaster.enableRecreationPortal;
    }

    // set in BaseLoggedInMaster.master
    export function EnableComplaintPortal() {
        BaseLoggedInMaster.complaintsEnabled;
    }

    // set in BaseLoggedInMaster.master
    export function EnableFacilityPortal() {
        return BaseLoggedInMaster.enableFacilityPortal;
    }
}

module TownSuite.Permissions {
    // set in BaseLoggedInMaster.master
    export function IsRecStaff() {
        return BaseLoggedInMaster.isRecStaff;
    }

    // set in BaseLoggedInMaster.master
    export function IsComplaintStaff() {
...
module TownsuiteHelpers {
    ...
    export function date_asis(value: string): Date {
        var utcDate = new Date(parseInt(value.replace('/Date(', '')));
        return utcDate;
    }
    ...
    export function getBool(val: string) {
    ...
    export function decodeEncodedHtml(encodedString: string): string {
    ...
    */
    function poll(fn, timeout, interval): JQueryDeferred<any> {
